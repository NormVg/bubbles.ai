...
**By Harrison Chase** | _April 11, 2026_
...
- **Worst:** When the whole harness, including long term memory, is behind an API.
...
- Is deployable:
    ...
    - Can bring your own database to serve as a memory store behind any standard web hosting framework
